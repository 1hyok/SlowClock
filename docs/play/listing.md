...
- 어르신·성인 학생·집중이 어려운 분을 위한 일정 추천을 참고할 수 있습니다.
...
- Google 계정으로 로그인합니다. 일정과 계정 정보는 Firebase에 저장되며 광고는 없습니다. 앱 사용 통계에는 IP 주소에서 추정한 대략적인 위치가 포함됩니다.
- 계정 삭제는 앱의 내 정보 화면에서 할 수 있습니다.

건강 관련 안내

느린 시계는 의료기기가 아니며 질환을 진단·치료·치유·예방하지 않습니다. 추천은 일상 일정의 예시입니다. 의료 조언, 진단 또는 치료가 필요하면 의료 전문가와 상담해 주세요.
